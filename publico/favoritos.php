    ...
    // Si no es admin y está intentando ver favoritos de otro usuario, denegar acceso
    ...
    <link rel="stylesheet" href="../recursos/css/estilos_favoritos.css" type="text/css"> <!-- Estilos específicos de favoritos -->
    <link rel="stylesheet" href="../recursos/css/estilos_index.css" type="text/css"> <!-- Estilos generales del index -->

    <main> <!-- Contenedor principal -->

        <h1 data-translate="favoritos"> <!-- Título principal de la página -->
            <?php 
            if($id_usuario !== $_SESSION['id_usuario']) { /* Si es otro usuario */
                echo 'Favoritos de: ' . htmlspecialchars($datos_usuario['nombre'] . ' ' . $datos_usuario['apellidos']); /* Muestro el nombre del usuario */
            } else { /* Si es el propio usuario */
                echo 'Mis Favoritos'; /* Muestro "Mis Favoritos" */
            }
            ?>
        ...
        <div id="contenedor-juegos" class="contenedor-juegos"> <!-- Contenedor específico para las tarjetas de juegos -->
            <!-- Aquí se cargarán los juegos favoritos dinámicamente -->
